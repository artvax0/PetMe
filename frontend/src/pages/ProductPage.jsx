    ...
    return (
      <>
        ...
        <Grid2 container mt={2.75} width='100%' gap={2} sx={{ backgroundColor: '#fff', borderRadius: '15px' }}>
          <Grid2 size={{ xs: 12, sm: 4 }} sx={{ boxShadow: 'inset 5px 5px 5px 0 rgba(0, 0, 0, .25), inset -5px -5px 5px 0 rgba(0, 0, 0, .25)', borderRadius: '5px' }}>
          ...
          <Grid2 display='flex' flexDirection='column' flexGrow={1} py={1} maxWidth={{ xs: '100%', sm: '64%' }} gap={{ xs: 2, sm: 0 }}>
            ...
            <Typography variant='body1' component='h3' fontWeight={theme.typography.fontWeightRegular} fontSize={{ xs: '1rem', sm: '1.25rem' }} flexGrow={1} px={{ xs: 1, sm: 0 }} gutterBottom>{product.description}</Typography>
            <Typography px={{ xs: 1, sm: 0 }} >This product is fit for:</Typography>
            ...
            <Typography variant='h5' display='inline-flex' justifyContent={{ xs: 'center', sm: 'unset' }} alignItems='center' gap={1} gutterBottom><InventoryIcon color='secondary' /> {product.stock}</Typography>
