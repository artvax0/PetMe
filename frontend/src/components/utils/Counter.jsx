...
export default function Counter({ count, setCount }) {
  ...
  return (
    <>
      ...
      <TextField value={count} aria-label='Quantity' type='number' onChange={(e) => handleValueChange(e)} slotProps={{ htmlInput: { min: 1, max: 100, style: { padding: 0, minWidth: '30px', minHeight: '30px', aspectRatio: '1/1' } }, input: { style: { boxShadow: 'rgba(0, 0, 0, 0.2) 0px 3px 1px -2px, rgba(0, 0, 0, 0.14) 0px 2px 2px 0px, rgba(0, 0, 0, 0.12) 0px 1px 5px 0px' } } }} />
